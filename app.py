...
class CasoEmblematico(db.Model):
    ...
    antecedentes = db.Column(db.String(600), nullable=True)
    descripcion_caso = db.Column(db.String(600), nullable=True)
    numero_afectados = db.Column(db.Integer, nullable=True)
    objetivo_defensa = db.Column(db.String(600), nullable=True)
    situacion_caso = db.Column(db.String(600), nullable=True)
    otro_dato = db.Column(db.String(600), nullable=True)
    fecha_registro = db.Column(db.DateTime, default=obtener_hora_peru, nullable=True)
    responsable_registro = db.Column(db.String(100), nullable=True)
    oficina_regional = db.Column(db.String(60), nullable=True, index=True)
...
class AvanceCasoEmblematico(db.Model):
    ...
    ocurrencias_periodo = db.Column(db.String(600), nullable=True)
    actividades_realizadas = db.Column(db.String(600), nullable=True)
    presencia_participacion = db.Column(db.String(600), nullable=True)
    estado_actual = db.Column(db.String(600), nullable=True)
    recomendaciones = db.Column(db.String(600), nullable=True)
    otro_asunto = db.Column(db.String(600), nullable=True)
    responsable_registro = db.Column(db.String(100), nullable=True)
    fecha_registro = db.Column(db.DateTime, default=obtener_hora_peru, nullable=True)
...
class PoliticaNacionalMemoria(db.Model):
    ...
    descripcion_propuesta = db.Column(db.String(600), nullable=True)
    ...
    organizaciones_aliadas = db.Column(db.String(600), nullable=True)
    otro_dato = db.Column(db.String(600), nullable=True)
    fecha_registro = db.Column(db.DateTime, default=obtener_hora_peru, nullable=True)
    responsable_registro = db.Column(db.String(100), nullable=True)
    oficina_regional = db.Column(db.String(60), nullable=True, index=True)
...
class AvancePoliticaMemoria(db.Model):
    ...
    ocurrencias_periodo = db.Column(db.String(600), nullable=True)
    actividades_realizadas = db.Column(db.String(600), nullable=True)
    estado_actual_gestion = db.Column(db.String(600), nullable=True)
    recomendaciones = db.Column(db.String(600), nullable=True)
    otro_asunto = db.Column(db.String(600), nullable=True)
    responsable_registro = db.Column(db.String(100), nullable=True)
    fecha_registro = db.Column(db.DateTime, default=obtener_hora_peru, nullable=True)
